...
wf = {
    ...
    "nodes": [
        ...
        # FIXED POSTGRES NODE: Direct Interpolation
        { 
            "parameters": { 
                "operation": "executeQuery", 
                "query": "SELECT slug FROM public.professionals WHERE slug = '{{ $json.params.slug }}' AND deleted_at IS NULL"
            }, 
            "id": "db_lookup", "name": "DB: Find Doctor", "type": "n8n-nodes-base.postgres", "typeVersion": 2.4, "position": [250, 0], "credentials": {"postgres": {"id": "aa8wMkQBBzGHkJzn", "name": "Postgres Neon"}} 
        },
        ...
        # REDIRECT (SET TO: setcalendarbot)
        { 
            "parameters": { 
...
print("✅ BB_09 (setcalendarbot + Direct SQL Fix) Generated.")